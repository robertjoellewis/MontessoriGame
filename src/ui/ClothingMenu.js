// Clothing Menu UI - Press C to open
// Handles appearance customization (bandana position, future: outfits)
...
export default class ClothingMenu {
    ...
    createMenu() {
        ...
        // Title
        const title = this.scene.add.text(menuX, menuY - menuHeight / 2 + 30, 'APPEARANCE', {
            fontSize: '28px',
            fill: '#2C1C0C',
            fontStyle: 'bold',
        ...
        // === CLOTHING SECTION ===
        this.createClothingSection(menuX, menuY);
    ...
    open() {
        ...
        console.log('Clothing menu opened');
    }
    ...
    close() {
        ...
        console.log('Clothing menu closed');
    }
    ...
    /**
     * Destroy the clothing menu (cleanup)
     */
    destroy() {
